...
const LocationMarker = ({ isDrag }) => {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg" className={`marker`} style={{ marginTop: isDrag ? "-20" : 0 }} viewBox="0 0 38 58">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className={`bottom-marker ${isDrag && "drag"}`} viewBox="0 0 18 18">
