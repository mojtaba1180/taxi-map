...
const LocationMarker = ({ isDrag, centerMode }: Prop) => {
    return (
        <React.Fragment>
            <svg xmlns="http://www.w3.org/2000/svg" className={`${centerMode ? "marker-center" : "marker"}`} style={{ marginTop: isDrag ? "-20" : 0 }} viewBox="0 0 38 58">
